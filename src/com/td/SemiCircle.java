 ...
 * a SemiCircle containing the vertex information
...
//        gl.glScalef(0.05f, 0.05f, 1.0f);
    ...
    public void nextWayPoint() {
        ...
        Log.i("SemiCircle", "Moving from wayPoint: " + currentWayPoint + "=>" + (currentWayPoint + 1) + " T:" + nWayPoints);
